...
function confirmar(){ 
confirmar=confirm("¿ESTAS SEGURO QUE QUIERES ELIMINAR ESTE GENERO?"); 
if (confirmar) 
// si pulsamos en aceptar
window.location.assign("eliminar_generos.php?dato=<?php echo $_GET['id']; ?>")
else 
...
//print_r($_GET);
$tra=new genero();
$tra->eliminar_generos($_GET["dato"]);
}
...
<p>&nbsp;</p>
<p>&nbsp; </p>
<h1 align="center" style="margin-top: -60px;">ELIMINAR GENERO</h1>
