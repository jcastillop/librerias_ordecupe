			...
			<table id="example"  class="display" cellspacing="0" width="100%">
				<thead>
					<tr class="cabecera" >
						...
						<th><a href="javascript:poptastic('generos.php');"><img src="../../../css/images/list-add.png" width="98" height="30" /></a></th>
                  ...
                  <td align='center' ><a href=" javascript:poptastic('mod_generos.php?id=<?php echo $reg[$i]["int_cod_gen"];?>'); " ><img src='../../../img/images/edit.png' width='15px' height='15px' title='Actualizar'></a></td>
						...
						<td><?php echo $reg[$i]["var_nom_gen"];?></td>
                        			<td><?php echo $reg[$i]["var_des_gen"];?></td>
						  			<td><?php echo $reg[$i]["int_est_gen"];?></td>
						
		
                       <td align='center' ><a href=" javascript:elim('eliminar_generos.php?id=<?php echo $reg[$i]["int_cod_gen"];?>'); " ><img src='../../../img/images/delete.png' width='15px' height='15px' title='Eliminar'></a></td>
