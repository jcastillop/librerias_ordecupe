...
function confirmar(){ 
confirmar=confirm("¿ESTAS SEGURO QUE QUIERES ELIMINAR ESTA SERIE?"); 
if (confirmar) 
// si pulsamos en aceptar
window.location.assign("eliminar_serie.php?ser_id=$cod_ser&suc_id=$cod_suc&emp_id=$cod_emp; ?>")
else 
...
if (isset($_GET['ser_id']) and isset($_GET['suc_id']) and isset($_GET['emp_id']))
{
require_once("../../../conexiones/class_serie.php");
require_once("../../../conexiones/conexion.php");
//print_r($_GET);
$tra=new serie();
$tra->eliminar_serie($_GET["suc_id"], $_GET["emp_id"], $_GET["ser_id"]);
}
...
<p>&nbsp;</p>
<p>&nbsp; </p>
<h1 align="center" style="margin-top: -60px;">ELIMINAR USUARIO</h1>
