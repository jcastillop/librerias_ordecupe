...
class ordcomp_detalle
{
		...
		public function get_ordcomp_detalle($cod_emp,$cod_suc,$cod_cab)
	{
		...
		$sql="select d.int_cod_emp, d.int_cod_suc, d.var_cod_comp_cab, d.var_cod_comp_det, d.int_cant_comp_det,
		truncate(d.dec_val_comp_det/d.int_cant_comp_det,2)*c.dec_fob_comp_cab as precio, d.int_cod_tit, t.var_nom_tit, t.var_autor_tit,e.var_nom_edit,p.var_rsoc_prov,
		ifnull(t.dec_preven_sug_tit,
		truncate((truncate(c.dec_may_comp_cab/100,2)+1)*truncate(d.dec_val_comp_det/d.int_cant_comp_det,2)*c.dec_fob_comp_cab,2)) as por_mayor, 
		ifnull(t.dec_preven_def_tit,
		truncate((truncate(c.dec_min_comp_cab/100,2)+1)*truncate(d.dec_val_comp_det/d.int_cant_comp_det,2)*c.dec_fob_comp_cab,2)) as por_menor
