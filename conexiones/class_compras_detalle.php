...
class ordcomp_detalle
{
		...
		public function get_ordcomp_detalle($cod_emp,$cod_suc,$cod_cab)
	{
		...
		t.dec_preven_sug_tit as def_por_mayor,
		truncate((truncate(c.dec_may_comp_cab/100,2)+1)*truncate((d.dec_val_comp_det/d.int_cant_comp_det)*c.dec_fob_comp_cab,2),2) as sug_por_mayor, 
		t.dec_preven_def_tit as def_por_menor, 
		truncate((truncate(c.dec_min_comp_cab/100,2)+1)*truncate((d.dec_val_comp_det/d.int_cant_comp_det)*c.dec_fob_comp_cab,2),2) as sug_por_menor
